    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            if index_to_middle_length < 30:
                pyautogui.moveTo(index_x * (screen_width / video_width), index_y * (screen_height / video_height))
            if thumb_to_index_length < 30:
                pyautogui.click()
            if middle_to_thumb_length < 30:
                pyautogui.mouseDown()
                pyautogui.moveTo(middle_x * (screen_width / video_width), middle_y * (screen_height / video_height))
